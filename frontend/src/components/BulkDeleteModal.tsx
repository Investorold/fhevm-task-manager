...
export function BulkDeleteModal({ isOpen, taskCount, onConfirm, onCancel }: BulkDeleteModalProps) {
      ...
      <div className="bg-white rounded-xl shadow-2xl max-w-md w-full p-6">
        ...
        <div className="mb-6">
          <p className="text-zama-gray-700 mb-3">
            Are you sure you want to <strong>REMOVE ALL {taskCount} TASKS</strong> from your list?
          </p>
          ...
          <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-3 mb-4">
            ...
            <ul className="text-xs text-yellow-700 space-y-1">
              <li>• All {taskCount} tasks will be <strong>REMOVED from your list</strong></li>
              <li>• <strong>Data remains in blockchain history</strong> (immutable)</li>
              <li>• Tasks cannot be <strong>recovered to your list</strong></li>
        ...
        <div className="flex space-x-3">
          ...
          >
            ...
            <span>REMOVE ALL {taskCount} TASKS</span>
          </button>
        </div>
      </div>
    </div>
